		...
		<div class="main_parametrs_group_div closed_params " >
			...
			<div class="inside_information_div">
				...
				<tbody> 
                    ...
                    <tr>
						<td>
							Logo maximum width<span class="pro_feature"> (pro)</span> <span title="Type here your logo maximum width." class="desription_class">?</span>
						</td>
						<td>
                    ...
                    <tr>
						<td>
							Logo maximum height<span class="pro_feature"> (pro)</span> <span title="Type here your logo maximum height." class="desription_class">?</span>
						</td>
						<td>
		...
		<div class="main_parametrs_group_div closed_params " >
			...
			<div class="inside_information_div">
				...
				<tbody> 
               		<tr>
						<td>
							Show Progress bar<span class="pro_feature"> (pro)</span> <span title="Choose to show or hide Progress bar on Coming soon page." class="desription_class">?</span>
						</td>
						<td>
		...
		<div class="main_parametrs_group_div closed_params " >
			...
			<div class="inside_information_div">
				...
				<tbody> 
               		<tr>
						<td>
							Show the Form<span class="pro_feature"> (pro)</span> <span title="Choose to show or hide Subscribe Form on Coming soon page." class="desription_class">?</span>
						</td>
						<td>
                    ...
                    <tr>
                     ...
                     <tr>
						<td>
							Blank email text<span class="pro_feature"> (pro)</span> <span title="Type here the text that will appear after users submit a blank field. " class="desription_class">?</span>
						</td>
						<td>
		...
		<div class="main_parametrs_group_div closed_params " >
			...
			<div class="inside_information_div">
				...
				<tbody> 
               		<tr>
						<td>
							Show social buttons <span title="Choose to show or hide social buttons on coming soon page." class="desription_class">?</span>
						</td>
						<td>
