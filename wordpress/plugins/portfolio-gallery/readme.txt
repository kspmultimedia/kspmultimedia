...
Over 572,057 our users who tried Portfolio Gallery, can prove it's great functionality and utility. 
...
Sorting in portfolio gallery is available even in free version. It in portfolio gallery is made to quickly view certain files within category by: date, name, ascending, descending, and so on.
...
To make those buttons work or just be seen on your front end, simply turn them on from the right side of portfolio gallery admin page.
...
The other source of adding videos in Vimeo. Attach the videos with your projects to make them more and more professional. As Youtube just insert the link into project.
...
1.  [WordPress Portfolio Gallery view 1](http://huge-it.com/wordpress-plugins-portfolio-gallery-demo/) - Blocks Toggle Up/Down
12.  [WordPress Portfolio Gallery view 1](http://huge-it.com/wordpress-plugins-portfolio-gallery-demo/) - Blocks Toggle Up/Down
2.  [WordPress Portfolio Gallery view 2](http://huge-it.com/wordpress-portfolio-gallery-demo-2-full-height-block/) - Full-Height Blocks
3.  [WordPress Portfolio Gallery view 3](http://huge-it.com/wordpress-portfolio-gallery-demo-3-gallery-content-popup/) - Gallery
4.  [WordPress Portfolio Gallery view 3.2](http://huge-it.com/wordpress-portfolio-gallery-demo-3-gallery-content-popup/) - Gallery / Content-Popup
5.  [WordPress Portfolio Gallery view 4](http://huge-it.com/wordpress-portfolio-gallery-demo-4-full-width-block/) - Full-Width Blocks
52.  [WordPress Portfolio Gallery view 4](http://huge-it.com/wordpress-portfolio-gallery-demo-4-full-width-block/) - Full-Width Blocks
6.  [WordPress Portfolio Gallery view 5](http://huge-it.com/wordpress-portfolio-gallery-demo-5-faq-toggle-updown/) - FAQ Toggle Up/Down
7.  [WordPress Portfolio Gallery view 6](http://huge-it.com/wordpress-portfolio-gallery-demo-6-content-slider/) - Content Slider
8.  [WordPress Portfolio Gallery view 7](http://huge-it.com/wordpress-portfolio-gallery-demo-7-lightbox-gallery/) - Lightbox - Gallery
9.  [WordPress Portfolio Gallery view 7.2](http://huge-it.com/wordpress-portfolio-gallery-demo-7-lightbox-gallery/) - Lightbox / Gallery - popup
...
* Link Button Text. Set text for the Show More button.ry
...
* Title Font Color. Choose color for the portfolio gallery title font.
...
* Title Font Size. Specify portfolio gallery font size for the title.
...
* Title Font Size. Specify font size for the portfolio gallery title
* Title Font Color. Choose color for the title font
* Title Font Hover Color. Choose color for the portfolio gallery title font when hovered
